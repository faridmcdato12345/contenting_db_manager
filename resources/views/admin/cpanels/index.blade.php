...
@endsection
@section('content')
    <p><a class="btn btn-success" href="javascript:void(0)" id="createNewProduct"> Create New Cpanel Account</a></p>
...
<script type="text/javascript">
    $(function () {
      ...
      $('body').on('click', '.editProduct', function () {
        ...
        $.get("{{ route('cpanels.index') }}" +'/' + product_id +'/edit', function (data) {
      ...
      $('body').on('click', '.deleteProduct', function () {
          ...
          $.ajax({
              type: "DELETE",
              url: "{{ route('cpanels.store') }}"+'/'+product_id,
              success: function (data) {
                  table.draw();
              },
              error: function (data) {
